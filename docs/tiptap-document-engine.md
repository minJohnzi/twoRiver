...
> 当前实施范围说明（2026-06-30）：本文保留为文档库与笔记能力的长期研究草案。后台文章编辑器的正式设计、数据权威规则、迁移边界和验收标准以 `docs/superpowers/specs/2026-06-30-tiptap-article-editor-design.md` 为准；本文中的文档表、双链、版本历史、协作与 AI 自定义块不进入当前文章编辑器实施计划。
